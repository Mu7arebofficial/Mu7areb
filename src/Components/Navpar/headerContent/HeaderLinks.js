    ...
    <>
                        {isLogin ?  
                            <>
                                ...
                                {isLogin && !isAdmin && isBrandOwner &&<div className='d-flex flex-row justify-content-start align-items-center '>
                                    <AiFillCrown className='text-white fs-1 fw-bold me-2'   />
                                    <h3 className='text-white text-center mt-1'>
                                        <Link to={`/brand/${userData?.brand}`} className='text-white'>{userData?.brand}</Link>
                                    </h3>
                                </div>}
