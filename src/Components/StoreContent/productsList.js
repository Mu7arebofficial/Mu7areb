        ...
        <>
            <div className='col-9 mt-4'>
                ...
                <div className='trending-clothes-content  row  d-flex justify-content-around '>
                    ...
                    {isLoading ? <Loader /> : data?.data?.products?.map((item) => {
                        return (
                            <Card  onClick={() => toast.success('adding Item Successfully')} key={item._id } class='col-6 col-md-4 col-lg-3 col-xl-2 pt-2 ' item={item} />
                        )
                    })}
