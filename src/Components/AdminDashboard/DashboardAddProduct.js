        ...
        <div className='dash-add-product p-2'>
            ...
            <form onSubmit={formHandler}>
                <div className='formInputs'>
                    <Input className="formInput" inputFun={titleHandler} inputPlaceHolder="Title" inputType="text" inputLabel='Title' />
                    <Input className="formInput" inputFun={priceHandler} inputPlaceHolder="Title" inputType="number" inputLabel='Price' />
                    <div className='d-flex justify-content-center align-items-start flex-column'>
                        <label className='mb-2'>Description</label> 
                        <textarea onChange={descriptionHandler} className='p-2' cols='38' rows='5' placeholder='Description'></textarea>
                    </div>
                </div>
                <div className='d-flex justify-content-between align-items-start dash-cat'>
                    <div className='dashSubCategories d-flex justify-content-center align-items-center flex-column'>
                        ...
                        <Input className="subCategoryInput" inputFun={subCategoryHandler} inputPlaceHolder="Title"  id="dresses" inputType="radio" inputLabel='Dresses' />
                        <Input className="subCategoryInput" inputFun={subCategoryHandler} inputPlaceHolder="Hoddies"  id="hoddies" inputType="radio" inputLabel='Hoddies' />
                        <Input className="subCategoryInput" inputFun={subCategoryHandler} inputPlaceHolder="Jackets"  id="jackets" inputType="radio" inputLabel='Jackets' />
                        <Input className="subCategoryInput" inputFun={subCategoryHandler} inputPlaceHolder="T-shirtses"  id="t-shirt" inputType="radio" inputLabel='T-shirts' />
                        <Input className="subCategoryInput" inputFun={subCategoryHandler} inputPlaceHolder="Track pants"  id="running" inputType="radio" inputLabel='Track pants' />
                    </div>
                    <div>
