    ...
    return (
        <div className='profile '>
            ...
            <div className='container'>
                { userData?.data?.data?.choosenUser.avatar.includes("http") &&<div className='profileImage mb-3 mt-2 d-flex justify-content-center'>
                ...
                <div className='profile-content d-flex flex-column align-items-start'>
                    <ProfileSection title="Your Name" content={`${userData?.data?.data?.choosenUser.firstName} ${userData?.data?.data?.choosenUser.lastName}`} />
                    <ProfileSection title="Your email" content={userData?.data?.data?.choosenUser.email} />
                    <ProfileSection title="Confirmed" content={userData?.data?.data?.choosenUser.role === "ADMIN" ? 'true' : 'false'} />
